...
namespace QuizIT.Service.IServices
{
    public interface IExamService
    {
        ...
        Task<ServiceResult<History>> CreateNewHistoryWithExample(int examId, System.Guid sessionId);
        Task<ServiceResult<int>> MarkPoint(int historyId, int examId, double timeDoExam, List<QuestionSelect> questionSelectLst);
    }
}
