...
namespace QuizIT.Service.Services
{
    public class QuestionService : IQuestionService
    {
        ...
        public QuestionService(QuizITContext dbContext)
        {
        ...
        public ServiceResult<Question> GetPage(FilterQuestion filter)
        {
            ...
            try
            {
                ...
                serviceResult.Result = _dbContext.Question
                    .Where(q =>
                ...
                serviceResult.TotalRecord = _dbContext.Question
                    .Where(q =>
                        q.Content.ToLower().Contains(filter.Name.ToLower()) &&
                        (filter.Category == -1 || q.CategoryId == filter.Category)
                    )
        ...
        public async Task<ServiceResult<string>> ImportExcel(List<Question> questionLst)
        {
            ...
            try
            {
                await _dbContext.Question.AddRangeAsync(questionLst);
        ...
        public async Task<ServiceResult<string>> Update(Question question)
        {
            ...
            try
            {
                ...
                var questionOld = _dbContext.Question.FirstOrDefault(q => q.Id == question.Id);
                //Sai id
                if (questionOld == null)
                {
                    serviceResult.ResponseCode = ResponseCode.NOT_FOUND;
                ...
                _dbContext.Question.Update(questionOld);
                await _dbContext.SaveChangesAsync();
        ...
        public async Task<ServiceResult<string>> Delete(Question question)
        {
            ...
            try
            {
                ...
                if (_dbContext.ExamDetail.FirstOrDefault(q => q.QuestionId == question.Id) != null)
                {
                ...
                {
                    _dbContext.Question.Remove(_dbContext.Question.FirstOrDefault(q => q.Id == question.Id));
                    await _dbContext.SaveChangesAsync();
                }
